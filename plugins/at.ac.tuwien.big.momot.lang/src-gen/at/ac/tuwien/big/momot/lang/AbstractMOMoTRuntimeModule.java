...
/**
 * Manual modifications go to {at.ac.tuwien.big.momot.lang.MOMoTRuntimeModule}
 */
@SuppressWarnings("all")
public abstract class AbstractMOMoTRuntimeModule extends org.eclipse.xtext.xbase.DefaultXbaseRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "at/ac/tuwien/big/momot/lang/MOMoT.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("at.ac.tuwien.big.momot.lang.MOMoT");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("momot");
	}
	...
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return at.ac.tuwien.big.momot.lang.services.MOMoTGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return at.ac.tuwien.big.momot.lang.serializer.MOMoTSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return at.ac.tuwien.big.momot.lang.serializer.MOMoTSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return at.ac.tuwien.big.momot.lang.parser.antlr.MOMoTParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return at.ac.tuwien.big.momot.lang.parser.antlr.MOMoTAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return at.ac.tuwien.big.momot.lang.parser.antlr.internal.InternalMOMoTLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<at.ac.tuwien.big.momot.lang.parser.antlr.internal.InternalMOMoTLexer> provideInternalMOMoTLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(at.ac.tuwien.big.momot.lang.parser.antlr.internal.InternalMOMoTLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(at.ac.tuwien.big.momot.lang.parser.antlr.internal.InternalMOMoTLexer.class);
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return at.ac.tuwien.big.momot.lang.formatting.MOMoTFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return at.ac.tuwien.big.momot.lang.jvmmodel.MOMoTJvmModelInferrer.class;
	}
