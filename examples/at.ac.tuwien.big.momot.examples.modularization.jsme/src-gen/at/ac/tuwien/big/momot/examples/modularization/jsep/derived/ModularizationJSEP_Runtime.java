...
public class ModularizationJSEP_Runtime {
  ...
  public class ModularizationJSEP_RuntimeFitnessFunction extends EGraphMultiDimensionalFitnessFunction {
    ...
    protected void preprocessEvaluation(final TransformationSolution solution) {
      final ModularizationModel root = MomotUtil.<ModularizationModel>getRoot(solution.execute(), ModularizationModel.class);
      solution.setAttribute("root", root);
      ModularizationCalculator _modularizationCalculator = new ModularizationCalculator(root);
      solution.setAttribute(ModularizationJSEP_Runtime.attribute, _modularizationCalculator);
    }
  }
  ...
  protected final int populationSize = 32768;
  ...
  protected double _createObjectiveHelper_0(final TransformationSolution solution, final EGraph graph, final EObject root) {
    ...
    {
      final ModularizationCalculator calculator = solution.<ModularizationCalculator>getAttribute(ModularizationJSEP_Runtime.attribute, ModularizationCalculator.class);
      _xblockexpression = calculator.getMetrics().coupling;
    }
  ...
  protected double _createObjectiveHelper_1(final TransformationSolution solution, final EGraph graph, final EObject root) {
    ...
    {
      final ModularizationCalculator calculator = solution.<ModularizationCalculator>getAttribute(ModularizationJSEP_Runtime.attribute, ModularizationCalculator.class);
      _xblockexpression = calculator.getMetrics().cohesion;
    }
    return _xblockexpression;
  }
  ...
  protected double _createObjectiveHelper_2(final TransformationSolution solution, final EGraph graph, final EObject root) {
    ...
    {
      final ModularizationCalculator calculator = solution.<ModularizationCalculator>getAttribute(ModularizationJSEP_Runtime.attribute, ModularizationCalculator.class);
      _xblockexpression = calculator.getMetrics().nrModules;
    }
    return _xblockexpression;
  }
  ...
  protected double _createObjectiveHelper_3(final TransformationSolution solution, final EGraph graph, final EObject root) {
    ...
    {
      final ModularizationCalculator calculator = solution.<ModularizationCalculator>getAttribute(ModularizationJSEP_Runtime.attribute, ModularizationCalculator.class);
      _xblockexpression = calculator.getMetrics().modularizationQuality;
    }
    return _xblockexpression;
  }
  ...
  protected double _createObjectiveHelper_4(final TransformationSolution solution, final EGraph graph, final EObject root) {
    ...
    {
      final ModularizationCalculator calculator = solution.<ModularizationCalculator>getAttribute(ModularizationJSEP_Runtime.attribute, ModularizationCalculator.class);
      _xblockexpression = calculator.getMetrics().minMaxDiff;
    }
    return _xblockexpression;
  }
  ...
  protected double _createConstraintHelper_0(final TransformationSolution solution, final EGraph graph, final EObject root) {
    final Function1<at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Class, Boolean> _function = (at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Class c) -> {
      at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Module _module = c.getModule();
      return Boolean.valueOf(Objects.equals(_module, null));
    };
    return IterableExtensions.size(IterableExtensions.<at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Class>filter(((ModularizationModel) root).getClasses(), _function));
  }
  ...
  protected double _createConstraintHelper_1(final TransformationSolution solution, final EGraph graph, final EObject root) {
    final Function1<at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Module, Boolean> _function = (at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Module m) -> {
      return Boolean.valueOf(m.getClasses().isEmpty());
    };
    return IterableExtensions.size(IterableExtensions.<at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Module>filter(((ModularizationModel) root).getModules(), _function));
  }
  ...
  protected IEGraphMultiDimensionalFitnessFunction createFitnessFunction(final TransformationSearchOrchestration orchestration) {
    IEGraphMultiDimensionalFitnessFunction function = new ModularizationJSEP_Runtime.ModularizationJSEP_RuntimeFitnessFunction();
  ...
  protected boolean _createEqualityHelperHelper_(final EObject left, final EObject right) {
    ...
    {
      if (((left instanceof at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Module) && (right instanceof at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Module))) {
        EObject _eContainer = left.eContainer();
        final int leftIndex = ((ModularizationModel) _eContainer).getModules().indexOf(left);
        EObject _eContainer_1 = right.eContainer();
        final int rightIndex = ((ModularizationModel) _eContainer_1).getModules().indexOf(right);
  ...
  protected TransformationResultManager handleResults(final SearchExperiment<TransformationSolution> experiment) {
    ...
    System.out.println("- Save objectives of all algorithms to 'data/output/runtime/approximationSet/momot_32768ps.pf'");
    TransformationResultManager.saveObjectives(
    	"data/output/runtime/approximationSet/momot_32768ps.pf",
    	population
    );
    System.out.println("---------------------------");
    ...
    population = 
    	TransformationResultManager.createApproximationSet(experiment, (String[])null);
    System.out.println("- Save models of all algorithms to 'data/output/models/runtime/momot_32768ps/'");
    TransformationResultManager.saveModels(
    	"data/output/models/runtime/momot_32768ps/",
    	baseName,
    	population
    );
    ...
    population = 
    	TransformationResultManager.createApproximationSet(experiment, (String[])null);
    System.out.println("---------------------------");
    System.out.println("Solutions of all algorithms");
    System.out.println("---------------------------");
  ...
  public static void main(final String... args) {
    initialization();
    ModularizationJSEP_Runtime search = new ModularizationJSEP_Runtime();
