...
public class ModularizationJSEP {
  ...
  protected double _createConstraintHelper_0(final TransformationSolution solution, final EGraph graph, final EObject root) {
    ...
    int _size = IterableExtensions.size(IterableExtensions.<at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Class>filter(((ModularizationModel) root).getClasses(), _function));
  ...
  protected double _createConstraintHelper_1(final TransformationSolution solution, final EGraph graph, final EObject root) {
    ...
    int _size = IterableExtensions.size(IterableExtensions.<at.ac.tuwien.big.momot.examples.modularization.jsme.modularization.Module>filter(((ModularizationModel) root).getModules(), _function));
    return (ModularizationJSEP.penalty * _size);
  }
